    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 mb-5 mb-lg-0 position-relative fade-up">
                <!-- Image/Pattern Placeholder -->
                <div class="rounded-4 overflow-hidden shadow-lg position-relative" style="aspect-ratio: 4/5; background: linear-gradient(135deg, #f0e9dd, #d49b78);">
                    <div class="position-absolute top-50 start-50 translate-middle text-center w-100 px-4">
                        <i class="bi bi-cup-hot text-white opacity-50" style="font-size: 8rem;"></i>
                    </div>
                    <!-- Overlay glass box -->
