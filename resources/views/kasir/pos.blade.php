            ...
            <div class="modal-body px-4 pb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button type="button" class="btn btn-outline-primary fw-bold rounded-pill px-3 py-2" onclick="addAnotherVariantSelection()" title="Tambah pesanan ini ke keranjang & pilih varian untuk porsi lain"><i class="bi bi-plus-circle me-1"></i>Porsi Lain</button>
                        <button type="button" class="btn btn-primary fw-bold rounded-pill px-4 py-2" onclick="confirmVariantSelection()">Tambahkan</button>
                    </div>
                </div>
            </div>
        </div>
